...
var	ERR_SPECIAL_APP_PUBLIC_PORT_RESERVE		=15004
...
var ERR_QOS_TOTAL_EGRESS_100M				=27000
...
var ERR_QOS_NOENT							=27005
var ERR_QOS_EXIST							=27006
var ERR_QOS_USEDBW							=27007
var ERR_QOS_NOBW							=27008
var ERR_QOS_BADRULE							=27009
var ERR_QOS_TYPE							=27010
var ERR_QOS_MAX								=27011
var ERR_QOS_INGRESS_BANDWIDTH				=27012
var ERR_QOS_EGRESS_BANDWIDTH				=27013
...
var ERR_LAN_GATEWAY_ERROR 					=500
var ERR_LAN_GATEWAY_IP						=501

var ERR_LAN_SAME_IP							=510	
var ERR_LAN_SAME_MAC 						=511
...
str_err[ERR_STATIC_DEST_CONFLICT_LAN]			=	"Destination IP address can not be in the same subnet with LAN IP address, please input another one.";
str_err[ERR_STATIC_DEST_CONFLICT_WAN]			=	"Destination IP address can not be in the same subnet with WAN IP address, please input another one.";
...
str_err[ERR_SAME_WAN_IP]						=   "The WAN IP address has been set by another WAN port, please choose another IP address";
...
str_err[ERR_VS_PORT_RESERVE]					=	"The service ports should not include the reserved ones (2048-2303) for the Router. Please renter another one."
...
str_err[ERR_SPECIAL_APP_PUBLIC_PORT_RESERVE]	=	"The incoming port should not include the reserved ones (2048-2240) for the Router. Please renter another one."
...
str_err[ERR_SYS_TFTP_FAIL]						=	"Upgrade unsuccessfully due to networking problem or you place the upgraded file in incorrect directory.";
...
str_err[ERR_LAN_GATEWAY_ERROR]					=  "Gateway must be set in a same subnet with LAN IP address. "
str_err[ERR_LAN_GATEWAY_IP]						=  "Bad gateway!"
str_err[ERR_LAN_SAME_IP]						= "The IP address is the LAN IP address, please input another one."
str_err[ERR_LAN_SAME_MAC]						= "The MAC address is the LAN MAC address, please input another one."